...
using NopStation.Plugin.Misc.AlgoliaSearch.Components;
...
{
    public class AlgoliaSearchPlugin : BasePlugin, IAdminMenuPlugin, IMiscPlugin, INopStationPlugin, IWidgetPlugin
    {
        #region Fields
        ...
        {
            return typeof(AlgoliaSearchViewComponent);
        }
