...
public partial interface ICountryModelFactory
{
    ...
    Task<ThanaListModel> PrepareThanaListModelAsync(ThanaSearchModel searchModel, StateProvince stateProvince);

    Task<ThanaModel> PrepareThanaModelAsync(ThanaModel model,
        StateProvince stateProvince, Thana thana, bool excludeProperties = false);

    Task<AreaListModel> PrepareAreaListModelAsync(AreaSearchModel searchModel, Thana thana);

    Task<AreaModel> PrepareAreaModelAsync(AreaModel model,
        Thana thana, Area area, bool excludeProperties = false);
}
