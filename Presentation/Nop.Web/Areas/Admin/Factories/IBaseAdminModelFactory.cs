...
public partial interface IBaseAdminModelFactory
{
    ...
    /// <summary>
    /// Prepare available thana
    /// </summary>
    /// <param name="items">thana items</param>
    /// <param name="countryId">state identifier; pass null to don't load thana</param>
    /// <param name="withSpecialDefaultItem">Whether to insert the first special item for the default value</param>
    /// <param name="defaultItemText">Default item text; pass null to use default value of the default item text</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task PrepareThanasAsync(IList<SelectListItem> items, int? stateProvinceId,
        bool withSpecialDefaultItem = true, string defaultItemText = null);

    /// <summary>
    /// Prepare available area
    /// </summary>
    /// <param name="items">area items</param>
    /// <param name="countryId">thana identifier; pass null to don't load area</param>
    /// <param name="withSpecialDefaultItem">Whether to insert the first special item for the default value</param>
    /// <param name="defaultItemText">Default item text; pass null to use default value of the default item text</param>
    /// <returns>A task that represents the asynchronous operation</returns>
    Task PrepareAreasAsync(IList<SelectListItem> items, int? thanaId,
        bool withSpecialDefaultItem = true, string defaultItemText = null);
    ...
    Task PrepareMerchantsAsync(IList<SelectListItem> items, bool withSpecialDefaultItem = true, string defaultItemText = null);
}