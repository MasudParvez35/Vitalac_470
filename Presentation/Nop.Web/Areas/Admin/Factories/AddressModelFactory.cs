...
public partial class AddressModelFactory : IAddressModelFactory
{
    ...
    public virtual async Task PrepareAddressModelAsync(AddressModel model, Address address = null)
    {
        ...
        //prepare available thanas
        await _baseAdminModelFactory.PrepareThanasAsync(model.AvailableThanas, model.StateProvinceId);

        //prepare available areas
        await _baseAdminModelFactory.PrepareAreasAsync(model.AvailableAreas, model.ThanaId);
