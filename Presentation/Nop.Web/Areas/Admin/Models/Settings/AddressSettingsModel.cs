...
public partial record AddressSettingsModel : BaseNopModel, ISettingsModel
{
    ...
    [NopResourceDisplayName("Admin.Configuration.Settings.CustomerUser.AddressFormFields.ThanaEnabled")]
    public bool ThanaEnabled { get; set; }

    [NopResourceDisplayName("Admin.Configuration.Settings.CustomerUser.AddressFormFields.AreaEnabled")]
