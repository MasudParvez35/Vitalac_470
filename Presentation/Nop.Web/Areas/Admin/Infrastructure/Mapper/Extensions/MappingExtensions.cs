...
public static class MappingExtensions
{
    ...
    /// <summary>
    /// Ignore mapping of a specific member
    /// </summary>
    /// <typeparam name="TSource"></typeparam>
    /// <typeparam name="TDestination"></typeparam>
    /// <typeparam name="TMember"></typeparam>
    /// <param name="mappingExpression">Expression</param>
    /// <param name="destinationMember">Member to ignore</param>
    /// <returns></returns>
    ...
    {
        return mappingExpression.ForMember(destinationMember, option => option.Ignore());
    }
