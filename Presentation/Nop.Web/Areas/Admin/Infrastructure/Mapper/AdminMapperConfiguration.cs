...
#pragma warning restore CS0618
    ...
    protected virtual void CreateCommonMaps()
    {
        CreateMap<Address, AddressModel>()
            ...
            .ForMember(model => model.AvailableThanas, options => options.Ignore())
            .ForMember(model => model.AvailableAreas, options => options.Ignore())
            ...
            .ForMember(model => model.ThanaName, options => options.Ignore())
            .ForMember(model => model.AreaName, options => options.Ignore())
    ...
    protected virtual void CreateDirectoryMaps()
    {
        ...
        CreateMap<Thana, ThanaModel>();
        CreateMap<ThanaModel, Thana>();
    ...
    /// <summary>
    /// Create merchant maps 
    /// </summary>
    protected virtual void CreateMerchantsMaps()
    {
        CreateMap<Merchant, MerchantModel>()
            .IgnoreMember(model => model.Address)
            .IgnoreMember(model => model.AssociatedCustomers)
            .ReverseMap()
            .IgnoreMember(model => model.Deleted);
    }
