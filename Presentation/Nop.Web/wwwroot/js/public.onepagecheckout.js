...
var Billing = {
  ...
  guest: false,
  selectedStateId: 0, selectedThanaId : 0, selectedAreaId : 0,
  ...
  setDefaultState: function (defaultState) {
    $('#opc-billing select[data-trigger="state-select"] option[value="' + defaultState + '"]').prop('selected', true);
    $('#opc-billing select[data-trigger="state-select"] option:selected').change()
  },

  setDefaultThana: function (defaultThana) {
    $('#opc-billing select[data-trigger="thana-select"] option[value="' + defaultThana + '"]').prop('selected', true);
    $('#opc-billing select[data-trigger="thana-select"] option:selected').change()
  },
    ...
    $.ajax({
      ...
      success: function (data, textStatus, jqXHR) {
        $.each(data, function (id, value) {
          ...
          if (id.indexOf("ThanaId") >= 0) {
            Billing.setSelectedThanaId(value);
          })
          if (id.indexOf("AreaId") >= 0) {
            Billing.setSelectedAreaId(value);
          })
        });
      },
  ...
  setSelectedThanaId: function (id) {
    this.selectedThanaId = id;
  },
  setSelectedAreaId: function (id) {
