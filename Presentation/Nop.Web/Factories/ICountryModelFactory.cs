...
public partial interface ICountryModelFactory
{
    ...
    Task<IList<ThanaModel>> GetThanasByStateProvinceIdAsync(int stateProvinceId, bool addSelectStateItem);

    Task<IList<AreaModel>> GetAreasByThanaIdAsync(int thanaId, bool addSelectStateItem);
}