...
public static partial class NopDirectoryDefaults
{
    ...
    /// {2} : show hidden records?
    /// </remarks>
    public static CacheKey ThanaByStateProvincesCacheKey => new("Nop.thana.bystateprovinces.{0}-{1}-{2}", NopEntityCacheDefaults<Thana>.Prefix);
    ...
    /// {0} : show hidden records?
    /// </remarks>
    public static CacheKey ThanasAllCacheKey => new("Nop.thana.all.{0}", NopEntityCacheDefaults<Thana>.Prefix);
    ...
    /// {2} : show hidden records?
    /// </remarks>
    public static CacheKey AreaByThanasCacheKey => new("Nop.area.bythanas.{0}-{1}-{2}", NopEntityCacheDefaults<Area>.Prefix);
    ...
    /// {0} : show hidden records?
    /// </remarks>
    public static CacheKey AreasAllCacheKey => new("Nop.area.all.{0}", NopEntityCacheDefaults<Area>.Prefix);
    #endregion
