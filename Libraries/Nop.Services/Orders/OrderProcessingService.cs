...
public partial class OrderProcessingService : IOrderProcessingService
{
    ...
    protected virtual async Task PrepareAndValidateCustomerAsync(PlaceOrderContainer details, ProcessPaymentRequest processPaymentRequest, Currency currentCurrency)
    {
        ...
        if (await _merchantService.GetMerchantByAreaIdAsync(details.Customer.AreaId) is not Merchant merchant)
            throw new NopException("No merchant available for given location");
