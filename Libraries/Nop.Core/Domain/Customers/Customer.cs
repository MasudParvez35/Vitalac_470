...
public partial class Customer : BaseEntity, ISoftDeletedEntity
{
    ...
    #region Vitalac properties

    /// <summary>
    /// Gets or sets the area identifier the customer is located
    /// </summary>
    public int AreaId { get; set; }

    /// <summary>
    /// Gets or sets the merchant identifier with which this customer is associated (manager)
    /// </summary>
