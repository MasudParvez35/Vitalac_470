...
public partial class AddressSettings : ISettings
{
    ...
    /// <summary>
    /// Gets or sets a Default State / province
    /// </summary>
    public int? DefaultStateProvinceId { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether Thana is enabled
    /// </summary>
    public bool ThanaEnabled { get; set; }

    /// <summary>
    /// Gets or sets a Default Thana
    /// </summary>
    public int? DefaultThanaId { get; set; }

    /// <summary>
    /// Gets or sets a value indicating whether Area is enabled
    /// </summary>
