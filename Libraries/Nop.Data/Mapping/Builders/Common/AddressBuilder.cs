...
public partial class AddressBuilder : NopEntityBuilder<Address>
{
    ...
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(Address.ThanaId)).AsInt32().Nullable().ForeignKey<Thana>(onDelete: Rule.None)
            .WithColumn(nameof(Address.AreaId)).AsInt32().Nullable().ForeignKey<Area>(onDelete: Rule.None);
    }
